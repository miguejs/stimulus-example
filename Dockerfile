...
ARG IMAGE_NAME="stimulus-example:latest"

LABEL org.label-schema.build-date=$BUILD_DATE \
      org.label-schema.name="Stimulus-example" \
      org.label-schema.description="stimulus-example" \
      org.label-schema.vcs-url="https://github.com/IcaliaLabs/stimulus-example.git" \
