...
* **Production** - [https://stimulus-example-production.herokuapp.com](https://stimulus-example-production.herokuapp.com)
* **Staging** - [https://stimulus-example-staging.herokuapp.com](https://stimulus-example-staging.herokuapp.com)
...
* [Github repo](https://github.com/IcaliaLabs/stimulus-example)
...
```bash
$ git clone git@github.com:IcaliaLabs/stimulus_example.git
...
You probably won't be working with a blank database, so once you are able to run stimulus-example you can restore the database, to do it, first stop all services:
...
```
% docker exec -ti stimulus_example_db_1 bash
```

This will open up a bash session in to the database container.

Up to this point we just need to download a database dump and copy under `stimulus-example/backups/`, this directory is mounted on the container, so you will be able to restore it with:

```
root@a3f695b39869:/# bin/restoredb stimulus_example_dev db/backups/<databaseDump>
```
